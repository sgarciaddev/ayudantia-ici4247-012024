...
import ObraCard, { ObraType, ObraCardVariant } from '@/components/obras/ObraCard';

import 'swiper/css';
import 'swiper/css/navigation';
import '@/styles/HomeSlider.css';

const obrasRecomendadas: Array<{
  title: string;
  id: number;
  type: ObraType;
  image: string;
...
const RecomendacionesObras: React.FC = () => {
  return (
    <div className='my-6 w-full px-4'>
      ...
      >
        {obrasRecomendadas.map((obra, index) => (
...
export default RecomendacionesObras;
