...
El proyecto se desarrolla en un entorno de desarrollo que incluye las siguientes herramientas:

- [![nodejs-badge-sm]][nodejs-web]
- [![npm-badge-sm]][npm-web] [![yarn-badge-sm]][yarn-web]
- [![ts-badge-sm]][ts-web] [![js-badge-sm]][js-web]
- [![vscode-badge-sm]][vscode-web]

### Prerequisitos

Para poder trabajar en el proyecto, es necesario contar con los siguientes prerequisitos:

> [!NOTE]
> Falta definir prerequisitos.
...
> [!NOTE]
> Falta definir scripts npm.

- `npm run <comando>` o `yarn <comando>` - Descripción del comando.
